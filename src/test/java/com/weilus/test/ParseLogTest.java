...
//        System.out.println(docs);
        ...
        PathMatcher matcher = FileSystems.getDefault().getPathMatcher("glob:**\\zuul.log*");
        boolean flag1 =  matcher.matches(Paths.get("D:\\data\\logs\\zuul.log"));
        boolean flag =  matcher.matches(Paths.get("D:\\data\\logs\\zuul.log.1"));
